...
export type ApiAction = {
  ...
  | {
      type:
        ...
        | 'GET_CONTACT_GROUPS_START'
        | 'GET_CONTACT_GROUPS_FAILURE'
        | 'CREATE_CONTACT_GROUP_START'
        | 'CREATE_CONTACT_GROUP_FAILURE'
        | 'ADD_CONTACT_TO_GROUP_START'
        | 'ADD_CONTACT_TO_GROUP_SUCCESS'
        | 'ADD_CONTACT_TO_GROUP_FAILURE'
        | 'REMOVE_CONTACT_TO_GROUP_START'
        | 'REMOVE_CONTACT_TO_GROUP_SUCCESS'
        | 'REMOVE_CONTACT_TO_GROUP_FAILURE'
        | 'GET_ACCOUNT_FAILURE'
        | 'GET_ACCOUNT_START'
        | 'REGISTER_START'
        | 'REGISTER_FAILURE'
  ...
  | {
      type:
        | 'IGNORE_SUGGESTION_START'
        | 'IGNORE_SUGGESTION_FAILURE'
