...
export type ApiAction = {
  ...
  type: 'LOGIN_START' | 'LOGIN_FAILURE' | 'USER_LOOKUP_START' |
      ...
      'GET_INBOX_START' | 'GET_INBOX_FAILURE' | 'ADD_CONTACT_SUCCESS' |
      'CREATE_CONTACT_GROUP_SUCCESS' |
      'GET_CONTACTS_START' | 'GET_CONTACTS_FAILURE' | 'ADD_CONTACT_START' |
      'ADD_CONTACT_FAILURE' | 'GET_CONTACT_GROUPS_START' |
      ...
      'GET_GAME_START' | 'GET_GAME_FAILURE',
} | {
